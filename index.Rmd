...
* Over five years as a government analyst
...
???
* I'm sorry if you came here expecting a different Dr Dray
...
???
* Apologies to anyone who thought Canada's best rapper would be here
...
???
* I don't want to condescend, I want to build from the general principle of 'reproducible is good'
...
Let's focus on two things today:
...
* If thse both mean nothing to you, then great
...
???
* Targets are any arbitrary values in memory (they must be files in Make)
...
???
* Using the built-in beaver datasets
