...
<img src="img/drake-hex.png" width="55%"/>
...
???
* I hope we can all agree that reproduciblity is good
* So why don't you have a think about using a workflow manager?
* And maybe consider {drake} as a good choice to do that
...
What about the _workflow_ itself?
...
```{r x-cached}
cached()  # stored in hidden .drake/ folder
```
...
outdated(config)  # what's changed?
```
...
* [slides](https://matt-dray.github.io/drake-bioinformatics/#1) in your browser
* [source](https://github.com/matt-dray/drake-bioinformatics) for the slides
* [.R script file](https://github.com/matt-dray/drake-bioinformatics/blob/master/drake-beavers-workflow.R) with all the {drake} code 
...
* [The other Dr Dre](https://commons.wikimedia.org/wiki/File:Snoop_Dogg_and_Dr._Dre.jpg)
* [Canadian rapper](https://commons.wikimedia.org/wiki/Category:Drake)
* {drake} [hex sticker](https://camo.githubusercontent.com/44749362ca36c9e3295f2bcf18975d811564c121/68747470733a2f2f646f63732e726f70656e7363692e6f72672f6472616b652f7265666572656e63652f666967757265732f6c6f676f2e737667)
* {drake} network from [a tweet by Frederik Aust](https://twitter.com/FrederikAust/status/1205103780938833921?s=20)